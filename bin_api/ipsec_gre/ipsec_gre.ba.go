...
// source: /usr/share/vpp/api/core/ipsec_gre.api.json
...
func (*IpsecGreTunnel) GetTypeName() string {
	return "ipsec_gre_tunnel"
}
func (*IpsecGreTunnel) GetCrcString() string {
	return "f9425226"
}
...
func (*IpsecGreTunnelAddDel) GetMessageName() string {
	return "ipsec_gre_tunnel_add_del"
}
func (*IpsecGreTunnelAddDel) GetCrcString() string {
	return "17985676"
}
func (*IpsecGreTunnelAddDel) GetMessageType() api.MessageType {
...
func (*IpsecGreTunnelAddDelReply) GetMessageName() string {
	return "ipsec_gre_tunnel_add_del_reply"
}
func (*IpsecGreTunnelAddDelReply) GetCrcString() string {
	return "fda5941f"
}
func (*IpsecGreTunnelAddDelReply) GetMessageType() api.MessageType {
